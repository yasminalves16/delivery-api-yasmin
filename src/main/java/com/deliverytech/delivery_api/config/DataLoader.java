...
public class DataLoader {
  ...
  public CommandLineRunner initData(CustomerRepository customerRepository, RestaurantRepository restaurantRepository,
      ...
      OrderItemRepository orderItemRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
    return args -> {
      ...
      // User restaurantUser1 = new User();
      // restaurantUser1.setName("Pizzaria Bella");
      // restaurantUser1.setEmail("pizzaria.bella@delivery.com");
      // restaurantUser1.setPassword(passwordEncoder.encode("12345"));
      // restaurantUser1.setRole(Role.RESTAURANT);
      // restaurantUser1.setActive(true);

      // User restaurantUser2 = new User();
      // restaurantUser2.setName("Burger House");
      // restaurantUser2.setEmail("burger.house@delivery.com");
      // restaurantUser2.setPassword(passwordEncoder.encode("12345"));
      // restaurantUser2.setRole(Role.RESTAURANT);
      // restaurantUser2.setActive(true);

      // User restaurantUser3 = new User();
      // restaurantUser3.setName("Sushi Master");
      // restaurantUser3.setEmail("sushi.master@delivery.com");
      // restaurantUser3.setPassword(passwordEncoder.encode("12345"));
      // restaurantUser3.setRole(Role.RESTAURANT);
      // restaurantUser3.setActive(true);

      // User adminUser = new User();
      // adminUser.setName("Yasmin Admin");
      // adminUser.setEmail("yasminadmin@mail.com");
      ...
      // userRepository.saveAll(Arrays.asList(restaurantUser1, restaurantUser2, restaurantUser3));

      // restaurant1.setUser(restaurantUser1);
      // restaurant2.setUser(restaurantUser2);
      // restaurant3.setUser(restaurantUser3);

      // restaurantUser1.setRestaurant(restaurant1);
      // restaurantUser2.setRestaurant(restaurant2);
      // restaurantUser3.setRestaurant(restaurant3);

      // List<Restaurant> restaurants = Arrays.asList(restaurant1, restaurant2, restaurant3);
      // restaurantRepository.saveAll(restaurants);

      // restaurantUser1.setRestaurantId(restaurant1.getId());
      // restaurantUser2.setRestaurantId(restaurant2.getId());
      // restaurantUser3.setRestaurantId(restaurant3.getId());
      // userRepository.saveAll(Arrays.asList(restaurantUser1, restaurantUser2, restaurantUser3));
